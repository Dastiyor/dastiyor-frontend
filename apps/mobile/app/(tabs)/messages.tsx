      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyHint}>Начните чат, откликнувшись на задание</Text>
          </View>
        }
        renderItem={({ item }) => (
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 16, paddingTop: 56, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
