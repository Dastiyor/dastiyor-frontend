        ...
        <div className="container" style={{ padding: '60px 20px', maxWidth: '800px' }}>
            ...
            <section style={sectionStyle}>
                ...
                <ul style={listStyle}>
                    ...
                    <li>Для отправки уведомлений об активности (email и SMS);</li>
                    <li>Для обработки платежей за подписку;</li>
            ...
            <section style={sectionStyle}>
                ...
                <ul style={listStyle}>
                    <li>Провайдер облачной базы данных;</li>
                    <li>Сервис транзакционных email и SMS-уведомлений;</li>
                    <li>Платёжный процессор для обработки подписок исполнителей;</li>
                    <li>Хостинг и CDN платформы.</li>
                </ul>
            ...
            <section style={sectionStyle}>
                ...
                <p style={textStyle}>
                    Ваши данные хранятся на защищённых облачных серверах с использованием шифрования. Пароли хранятся
