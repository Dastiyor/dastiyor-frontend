...
export default function ProviderProfileScreen() {
  ...
  useEffect(() => {
    if (!id) return;
    api
      .get<{ user: ProviderProfile }>(`/api/users/${id}`)
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scroll}>
      <View style={styles.header}>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statBox}>
            ...
            <Text style={styles.statLabel}>{profile.reviewCount} отзывов</Text>
          </View>
        </View>
      </View>
      ...
      {profile.skills ? (
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Навыки</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            router.push({
              ...
              params: { partnerId: profile.id, partnerName: profile.fullName },
            })
          }
        >
      ...
      <View style={styles.reviewsSection}>
        {profile.reviews.length > 0 ? (
          <>
            <Text style={styles.sectionTitle}>Отзывы ({profile.reviewCount})</Text>
